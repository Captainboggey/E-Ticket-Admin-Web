...
const CounterUsedTickets = () => {
    ...
    fetch("https://e-ticket-server-pi.vercel.app/tickets")
      ...
      .then((data) => {
        const filtered = data.filter(
          (t) => t.ticketType === "counter" && t.status === "used"
        );
        setTickets(filtered);
  ...
  const handlePrintPDF = () => {
    ...
    doc.setFontSize(18);
    doc.text("Used Counter Ticket Report", 40, 40);

    doc.setFontSize(12);
    doc.text(`Total Used Counter Tickets: ${filteredTickets.length}`, 40, 60);
    ...
    doc.save("Used_Counter_Ticket_Report.pdf");
  };
